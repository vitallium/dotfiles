...
(setq
 ;; Fonts
 ;; Primary font to use
 doom-font (font-spec :family "Berkeley Mono Variable" :size 16)
 ;; Non-monospace font
 doom-variable-pitch-font (font-spec :family "iA Writer Duo S" :size 16)
 ;; For big-font-mode
 doom-big-font (font-spec :family "Berkeley Mono Variable" :size 20)
 ;; For unicode glyphs
 ;; (doom-unicode-font)
