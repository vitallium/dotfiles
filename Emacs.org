...
- [[#basic-configuration][Basic configuration]]
  ...
  - [[#additional-stuff-to-work-with-strings][Additional stuff to work with strings]]
  - [[#evil][Evil]]
...
- [[#languages][Languages]]
  ...
  - [[#markdown][Markdown]]
- [[#lsp][LSP]]
  - [[#enabledisable-some-lsp-features][Enable/disable some LSP features]]
  - [[#flycheck][Flycheck]]
- [[#org][Org]]
  - [[#packages][Packages]]
  - [[#setup-org-directories][Setup ~org~ directories]]
  - [[#configure-org][Configure ~org~]]
  - [[#roam][Roam]]
- [[#mail][Mail]]
  - [[#mu4e][mu4e]]
  - [[#setup-accounts][Setup accounts]]
  - [[#setup-mu4e-alert-for-notifications][Setup ~mu4e-alert~ for notifications]]
...
- [[#magit][Magit]]
  ...
  - [[#integration-with-delta][Integration with delta]]
...
** js2-mode
Snippets for ~jest~.
#+begin_src sh :tangle snippets/js2-mode/desribe
# name : describe('...', () => { ... })
...
#+begin_src sh :tangle snippets/js2-mode/it
# name : it('...', () => { ... })
# contributor : Seong Yong-ju <sei40kr@gmail.com>
# key: it
# --
