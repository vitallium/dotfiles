...
- [[#asdf][asdf]]
  ...
  - [[#default-ruby-gems][Default Ruby gems]]
  - [[#default-go-packages][Default Go packages]]
...
#+begin_src sh :tangle ~/.default-npm-packages
yarn
yarn-deduplicate
vls
typescript
...
#+end_src
** Default Go packages
#+begin_src sh :tangle ~/.default-golang-pkgs
