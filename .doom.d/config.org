...
(:if (>= emacs-major-version 28) ligatures)
...
(setq doom-font (font-spec :family "MonoLisa" :size 17)
      doom-big-font (font-spec :family "MonoLisa" :size 23)
...
*** Ellograph CF
#+begin_src emacs-lisp :tangle no
(setq doom-font (font-spec :family "Ellograph CF" :size 17)
      doom-big-font (font-spec :family "Ellograph CF" :size 23)
      doom-variable-pitch-font (font-spec :family "Ellograph CF" :size 17))
#+end_src
