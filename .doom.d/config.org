...
#+begin_src emacs-lisp :tangle no
(setq doom-font (font-spec :family "PragmataPro Mono Liga" :size 20 :weight 'normal)
   doom-big-font (font-spec :family "PragmataPro Mono Liga" :size 22)
   doom-variable-pitch-font (font-spec :family "PragmataPro Mono Liga" :size 18 :weight 'normal))
#+end_src
And I use MonoLisa sometimes.
#+begin_src emacs-lisp
